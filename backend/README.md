...
## Project Structure
    ...
    ├── apheresis_guideline_33255  # Django project configurations
...
1. Clone this repo and `cd apheresis_guideline_33255`
...
2. Clone this repo and `cd apheresis_guideline_33255`
